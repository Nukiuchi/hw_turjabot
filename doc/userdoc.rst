...
1. To check that *DiffBot* description is working properly use following launch commands
   ...
   .. code-block:: shell
    ...
    ros2 launch hw_turjabot view_robot.launch.py
...
2. To start *DiffBot* example open a terminal, source your ROS2-workspace and execute its launch file with
   ...
   .. code-block:: shell
    ...
    ros2 launch hw_turjabot diffbot.launch.py
...
5. If everything is fine, now you can send a command to *Diff Drive Controller* using ROS 2 CLI interface:
   ...
   .. code-block:: shell
    ...
    [TurjabotHardware]: Got command 43.33333 for 'left_wheel_joint'!
    [TurjabotHardware]: Got command 50.00000 for 'right_wheel_joint'!
...
6. Let's introspect the ros2_control hardware component. Calling
  ...
  .. code-block:: shell
    ...
    Hardware Component 1
            name: DiffBot
            type: system
            plugin name: hw_turjabot/TurjabotHardware
  ...
  .. code-block:: shell
    ...
    ros2 launch hw_turjabot diffbot.launch.py use_mock_hardware:=True
...
* Hardware interface plugin: `turjabot_hardware.cpp <https://github.com/ros-controls/ros2_control_demos/tree/{REPOS_FILE_BRANCH}/example_2/hardware/turjabot_hardware.cpp>`__
